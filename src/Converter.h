...
public:
    ...
    static void RmatOfQuat(cv::Mat &M, const Eigen::Quaternion<double> &q);
    static std::vector<float> toEulr(const cv::Mat &M);
    static std::vector<float> toEulr(const Eigen::Quaterniond &_q);    
};
